...
public class WebNodeManage extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        String id = null;
        String Floor = null, Building = null;
           ...
           while (retry > 0) {
                try {
                    ...
                    if(isDelete){
                        ...
                        Node n = new Node(id, Junction, Elevator, Building, Floor, image);
                        n.setOutside(Outside);
                        n.setNessOutside(NessOutside);
                        n.setDirection(direction);
                        if(itemResProvider.insertItem(n, conn)){
                            respPage = RESOURCE_SUCCESS_TAG;
                        }
